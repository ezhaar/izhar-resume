...
\name{Izhar}{ul Hassaan}
\address{Stockholm, Sweden}
\mobile{(+46) 72-537-5777}

\email{ezhaar@gmail.com}
\homepage{ezhaar.github.io}
\github{ezhaar}
\linkedin{ezhaar}
%\skype{skypeid}
...
\position{Systems Engineer{\enskip\cdotp\enskip}Big Data Architect{\enskip\cdotp\enskip}DevOps Engineer} % Your expertise/fields
\quote{``We are bound by our choices, but we are more than our mistakes."} % A quote or statement

\makecvfooter{\today}{Izhar ul Hassan~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
